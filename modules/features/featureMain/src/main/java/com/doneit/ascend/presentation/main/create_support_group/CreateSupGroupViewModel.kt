...
@CreateFactory
@ViewModelDiModule
class CreateSupGroupViewModel(
    private val groupUseCase: GroupUseCase,
    private val router: CreateSupGroupContract.Router,
    ...
    override fun applyArguments(argsSup: CreateSupGroupArgs) {
        createGroupModel.groupType = argsSup.groupType
    }
